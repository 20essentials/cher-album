...
let nameSongs = [
  ...
  'TAXI, TAXI' /*6*/,
  ' LOVE IS TO GROOVE' /*7*/,
  'GYPSIES, TRAMPS & THIEVES' /*8*/,
  'DARK LADY' /*9*/,
  'JUST LIKE JESSE JAMES' /*10*/,
  'DANGEROUS TIME' /*11*/,
  'PERFECT' /*12*/,
  'I FOUND SOMEONE' /*13*/,
  'SAVE UP ALL YOUR TEARS' /*14*/,
  'THE SHOOP SHOOP SONG' /*15*/,
  "I'LL NEVER STOP LOVING YOU" /*16*/,
  'ONE BY ONE' /*17*/,
  'WALKING IN MEMPHIS' /*18*/,
  'LOVE AND UNDERSTANDING' /*19*/,
  'WHO YOU GONNA BELIEVE' /*20*/
];
